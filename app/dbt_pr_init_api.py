...
class K8SInputSchema(Schema):
    ...
    tsb_dbt_core_image_version = String(required=False, load_default='europe-central2-docker.pkg.dev/fast-bi-common/bi-platform/tsb-dbt-core:latest', dump_default='europe-central2-docker.pkg.dev/fast-bi-common/bi-platform/tsb-dbt-core:latest', metadata={'title': 'TSB DBT Core Image Version', 'description': 'The version of the TSB DBT core image.', 'example': 'europe-central2-docker.pkg.dev/fast-bi-common/bi-platform/tsb-dbt-core:latest'})
...
class APIInputSchema(Schema):
    ...
    tsb_dbt_core_image_version = String(required=False, dump_default='europe-central2-docker.pkg.dev/fast-bi-common/bi-platform/tsb-dbt-core:latest', metadata={'title': 'TSB DBT Core Image Version', 'description': 'The version of the TSB DBT core image.', 'example': 'europe-central2-docker.pkg.dev/fast-bi-common/bi-platform/tsb-dbt-core:latest'})
